    ...
    <div class="container"><a class="navbar-brand" href="#"><fmt:message key="msg.repair.agency"/></a>
        ...
        <div class="collapse navbar-collapse"
            ...
            <a class="btn" id="locales"
               href="?sessionLocale=en"><img
                    src="${pageContext.request.contextPath}/static/United-Kingdom-flag-icon.png" height="30px"/></a>
            <a class="btn"
               href="?sessionLocale=ua"><img src="${pageContext.request.contextPath}/static/Ukraine-Flag-icon.png"
                                             height="30px"/> </a>
        </div>
    </div>
</nav>
<%--<a href="${pageContext.request.contextPath}/app/user/create_comment"> See my requests</a>--%>
<div style="margin:0 auto;"
    ...
    <div class="col" style="width: 404px; align:center;">
        <c:if test="${requestScope.sucess eq true}">
            <div class="alert alert-primary" align="center">
                <strong><fmt:message key="message.comment.created"/></strong>
            </div>
        </c:if>
        <form action="${pageContext.request.contextPath}/app/user/create_comment"
              method="get">
            <label><fmt:message key="message.new.comment"/></label>
            <br/>

...
public class UserAllRequest implements Command {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            requestService.findByCreatorAndStatus(userName,"rejected").
                    ifPresent(requests->request.setAttribute("rejectRequests",requests));
            requestService.findByCreatorAndNotStatus(userName, "rejected", page,size).
                    ifPresent(requests->request.setAttribute("requests",requests));
